...
DTNtupleTPGBaseAnalyzer::DTNtupleTPGBaseAnalyzer(const TString &inFileName) : 
...
DTNtupleTPGBaseAnalyzer::~DTNtupleTPGBaseAnalyzer()
{
   m_inFile.Close();
}


Int_t DTNtupleTPGBaseAnalyzer::GetEntry(Long64_t entry)
{
...
Long64_t DTNtupleTPGBaseAnalyzer::LoadTree(Long64_t entry)
{
...
void DTNtupleTPGBaseAnalyzer::Init(TTree *tree)
{
...
Bool_t DTNtupleTPGBaseAnalyzer::Notify()
{
...
void DTNtupleTPGBaseAnalyzer::Loop()
{
   if (fChain == 0) return;
