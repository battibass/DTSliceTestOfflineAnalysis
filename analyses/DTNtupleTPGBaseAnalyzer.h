...
#ifndef DTNtupleTPGBaseAnalyzer_h
#define DTNtupleTPGBaseAnalyzer_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   DTNtupleTPGBaseAnalyzer(const TString &fileName);
   virtual ~DTNtupleTPGBaseAnalyzer();
