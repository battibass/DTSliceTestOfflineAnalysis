...
public:
  DTNtupleTriggerAnalyzer(const TString& inFileName, const TString& outFileName);

  DTNtupleTriggerAnalyzer(const std::vector<TString>& inFileNames, const TString& outFileName);
...
protected:
  ...
  UInt_t getBestSegm(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTwinMuxOut(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTwinMuxOutBXOK(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTpgPhiHw(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTpgPhiHwBXOK(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTpgPhiEmuAm(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTpgPhiEmuAmBXOK(const Int_t muSt, const Int_t muSec, const Int_t muWh);

  UInt_t getBestTpgPhiEmuHb(const Int_t muSt, const Int_t muSec, const Int_t muWh);
